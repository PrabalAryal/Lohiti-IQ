      ...
      <section className="">
        <div className="mx-auto max-w-screen-xl px-4 py-32 lg:flex lg:h-screen justify-center lg:items-center">
          <div className="mx-auto max-w-xl text-center flex flex-col items-center justify-center">
            <ul className="text-left mt-4 sm:text-xl/relaxed p-2">
              ...
              <li>
                Refrain from using calculators or other external servics during
                the test.
              </li>
              <li>Unanswered questions will be considered as wrong answers.</li>
            </ul>
